...
h1. How coolDevOps works

We follow the Crisp core values. For the moment we used their "Crisp Strategy A3":http://dna.crisp.se/assets/CrispStrategyA3-en.pdf as example to model our own.
